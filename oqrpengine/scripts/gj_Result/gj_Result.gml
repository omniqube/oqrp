// GameJolt Result Functions

function gj_result_status() {
	//gj_checkstatus()
...
function gj_result_data_field(argument0) {
...
function gj_result_data_field_num(argument0, argument1) {
