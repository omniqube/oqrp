...
exception_unhandled_handler( function (exception) {
	window_set_caption("OQRP ENGINE EXCEPTION");
		...
		"--- Diagnostic Info ---\n" +
		"Engine Build: " + string(global.oqrp_engine_version) + "\n" +
		"Game Build: " + string(global.oqrp_game_version) + "\n\n" +
...
function memlog(exception) {
	...
	var _f = file_text_open_write(global.oqrp_errorlog_directory + _filename);
