...
function saveExists() {if (file_exists(global.oqrp_save_directory + "save.oqrpsav")) {return true;} else {return false;}}
...
function Savegame() {
	SignSave();
	if (saveExists) {file_delete(global.oqrp_save_directory + "save.oqrpsav")}
	ds_map_secure_save(global.save, global.oqrp_save_directory + "save.oqrpsav");
}
...
function Loadgame() {
	...
	global.save = ds_map_secure_load(global.oqrp_save_directory + "save.oqrpsav");
	
}

function SaveCorruptionCheck() {
	_svcheck = ds_map_secure_load(global.oqrp_save_directory + "save.oqrpsav");
